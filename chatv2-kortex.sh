#!/bin/bash
echo "Assistant : Hello depuis le script Bash !"
PROMPT="$1"
echo "Utilisateur : $PROMPT"
echo "Assistant : Voici une réponse simulée de SMKortex."
...
PROMPT_SYSTEM="Tu es un assistant IA francophone, factuel et bienveillant.\n\nUtilisateur : bonjour\nAssistant : Bonjour 👋 Je suis SMKortex, ton copilote IA local. Comment puis-je t’aider aujourd’hui ?"
